...
public class Accept extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecylcler = findViewById(R.id.list_accept);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("bookingAccepting");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new AcceptAdapter(getApplicationContext(), list);

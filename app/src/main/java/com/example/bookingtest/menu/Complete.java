...
import com.example.bookingtest.adapter.CompleteAdapter;
...
public class Complete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecylcler = findViewById(R.id.list_complete);
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("bookingCompleted");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new CompleteAdapter(getApplicationContext(), list);

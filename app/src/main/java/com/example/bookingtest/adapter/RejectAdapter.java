...
import com.example.bookingtest.detail.DetailReject;
import com.example.bookingtest.model.DataBooking;

import java.util.ArrayList;

public class RejectAdapter extends RecyclerView.Adapter<RejectAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<DataBooking> dataBookings;

    public RejectAdapter(Context cont, ArrayList<DataBooking> data) {
        context = cont;
        dataBookings = data;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_reject, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.btndetail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent detail = new Intent(context.getApplicationContext(), DetailReject.class);

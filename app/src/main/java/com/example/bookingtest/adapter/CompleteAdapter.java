...
import com.example.bookingtest.detail.DetailComplete;
...
public class CompleteAdapter extends RecyclerView.Adapter<CompleteAdapter.MyViewHolder> {
    ...
    public CompleteAdapter(Context cont, ArrayList<DataBooking> data) {
        context = cont;
        dataBookings = data;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.btndetail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent detail = new Intent(context.getApplicationContext(), DetailComplete.class);

...
import com.example.bookingtest.detail.DetailWait;
import com.example.bookingtest.model.DataBooking;

import java.util.ArrayList;

public class WaitAdapter extends RecyclerView.Adapter<WaitAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<DataBooking> dataBookings;

    public WaitAdapter(Context cont, ArrayList<DataBooking> data) {
        context = cont;
        dataBookings = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_wait, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WaitAdapter.MyViewHolder holder,final int position) {
        ...
        holder.btndetail.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                Intent detail = new Intent(context.getApplicationContext(), DetailWait.class);
